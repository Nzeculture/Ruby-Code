...
v_Email = 'testing@yahoo.com'
v_Comment = 'Do not call weekends'
...
#Enter email Address
browser.text_field(:name=> 'ctl00$MainContent$txtEmail').set v_Email
...
browser.textarea(:name=> 'ctl00$MainContent$txtInstructions').set v_Comment
